...
% სქრინშოტის ადგილის დამჭერი (შემდეგ ჩაანაცვლეთ \appscreenshot-ით)
\newcommand{\screenshot}[1]{%
  \begin{center}
    \fbox{\parbox[c][6cm][c]{0.85\textwidth}{\centering [insert #1]}}
  \end{center}}

% რეალური სქრინშოტის ჩასმა: PNG ჩააგდეთ images/ საქაღალდეში და დაწერეთ
%   \appscreenshot{images/editor.png}{მთავარი ფანჯარა}{fig:editor}
% arg1 = ფაილი, arg2 = წარწერა (caption), arg3 = label (ტექსტში \ref-ისთვის).
% ნუმერაცია და „სურათები“ სიაში მოხვედრა ავტომატურია.
...
\begin{titlepage}
  \begin{center}
    \vspace*{0.2cm}
    \includegraphics[width=4.6cm]{images/logo.png}\\[0.9cm]

    {\Large თბილისის თავისუფალი უნივერსიტეტი}\\[0.7cm]

    {\large მათემატიკის, კომპიუტერული მეცნიერების და ინჟინერიის\\
    სკოლა (MACS[E])}\\[0.6cm]

    {\large კომპიუტერული მეცნიერებისა და მათემატიკის პროგრამა}\\[0.9cm]

    არევაძე მათე\\[0.35cm]
    ჭიჭინაძე ქეთი\\[0.35cm]
    გელაშვილი გიორგი\\[0.6cm]

    საბაკალავრო პროექტი\\[0.5cm]
...
\input{sections/crdt_core}
\input{sections/tauri_app}
\input{sections/frontend}
\input{sections/gateway}

...
\begin{enumerate}[itemsep=0pt]
  \item \textbf{desktop აპლიკაცია} (\texttt{tauri-app}), მას ყველა
        მონაწილე უშვებს. სწორედ აქ ცხოვრობს დოკუმენტის CRDT ასლი, Monaco
        რედაქტორი და სესიის მართვის მთელი ლოგიკა.
  \item \textbf{გეითვეი} (\texttt{gateway}), Go-ზე დაწერილი WebSocket
        სარელეო სერვერი, რომელსაც \emph{მხოლოდ ჰოსტის} აპლიკაცია უშვებს
  ...
  \item \textbf{Cloudflared გვირაბი}, არასავალდებულო დამხმარე პროცესი,
...
როდესაც მომხმარებელი სესიის წამოწყებას (hosting) ირჩევს, აპლიკაცია
თანმიმდევრულად ასრულებს შემდეგ ნაბიჯებს: (1) უშვებს გეითვეის პროცესს და
მისგან სტანდარტულ გამოსავალზე (stdout) დაბეჭდილი JSON შეტყობინებით იგებს,
რომელ პორტზე დაიწყო მუშაობა; (2) საუკეთესო ძალისხმევის პრინციპით უშვებს
...
ამის შემდეგ ჰოსტი ორ ბმულს იღებს, ლოკალური ქსელისა და საჯაროს, და
ორივეს ერთი ღილაკით გააზიარებს. სტუმრის მხარეს იგივე პროცესი ბევრად
...
სტუმრები, ნაგულისხმევად, მხოლოდ კითხვის რეჟიმში ერთვებიან (ჰოსტს შეუძლია
...
არ აპაკეტებს) და ბექენდის ენად Rust გვქონდა, რაც ჩვენთვის გადამწყვეტი იყო -
...
\subsubsection{ფრონტენდი და Monaco, როგორც ჩონჩხი}

ინტერფეისის ბირთვად Monaco Editor \cite{monaco} ავირჩიეთ, იგივე
რედაქტორის კომპონენტი, რომელზეც VS Code დგას. ეს არჩევანი ბევრ რამეს
გვაძლევს „უფასოდ“: სინტაქსის გაფერადება, მრავალკურსორიანი რედაქტირება,
undo/redo, ძებნა და კლავიატურის ნაცნობი მალსახმობები. ჩვენი ფრონტენდი
Monaco-ს გარშემოა შემოწერილი: React მართავს აპლიკაციის „გარსს“ (გვერდითი
...
მიდის, დაშორებული მონაწილეების ცვლილებები კი ბექენდიდან ივენთებით ბრუნდება
და რედაქტორში ისე ჩაესმება, რომ ხელახლა არ გავრცელდეს. ამ ორმხრივი ნაკადის
დეტალებს ფრონტენდის თავში აღვწერთ.
